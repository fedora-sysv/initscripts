...
Conflicts: kernel <= 2.2, timeconfig < 3.0, ppp < 2.3.9, wvdial < 1.40-3
...
* Fri Apr 12 2002 Bill Nottingham <notting@redhat.com>
...
* Wed Feb  6 2002 Bill Nottingham <notting@redhat.com>
- backport assorted fixes from -HEAD
