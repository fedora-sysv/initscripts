...
rm %{buildroot}/etc/sysconfig/network-scripts/ifup-ctc
rm %{buildroot}/etc/sysconfig/network-scripts/ifup-escon
rm %{buildroot}/etc/sysconfig/network-scripts/ifup-iucv
%endif
